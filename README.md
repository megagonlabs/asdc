...
## Supplemental SCUD part: [``data/supplemental/scud``](data/supplemental/scud): 36,609 examples
...
- Dialogs are stored in files in [``data/supplemental/utterances``](data/supplemental/utterances) : 36,006 dialogs

...
## Supplemental SCUD part: [``data/supplemental/scud``](data/supplemental/scud): 49,161 examples
...
- Dialogs are stored in files in [``data/supplemental/utterances``](data/supplemental/utterances) : 49,391 dialogs

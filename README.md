...
## Supplemental SCUD part: [``data/supplemental/scud``](data/supplemental/scud): 49,160 examples
...
- Dialogs are stored in files in [``data/supplemental/utterances``](data/supplemental/utterances) : 49,390 dialogs
...
## Vanilla part: [``data/vanilla``](data/vanilla): 73,397 dialogs

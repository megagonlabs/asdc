...
## Supplemental SCUD part: [``data/supplemental/scud``](data/supplemental/scud): 57,055 examples
...
- Dialogs are stored in files in [``data/supplemental/utterances``](data/supplemental/utterances) : 50,999 dialogs
